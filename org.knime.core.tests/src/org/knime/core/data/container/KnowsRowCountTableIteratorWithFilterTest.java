...
public class KnowsRowCountTableIteratorWithFilterTest {
    ...
    private static final Node NODE = new Node((NodeFactory)new VirtualParallelizedChunkPortObjectInNodeFactory(new PortType[0]));

    @SuppressWarnings({"rawtypes", "unchecked"})
    private static final ExecutionContext EXEC = new ExecutionContext(PROGRESS, NODE,
